#------------------------------------------------------------------------------
# Program Name: C1.2.Fugitive-petr-and-gas_default_process_emissions_EDGARv432.R
# Author: Erin McDuffie, adapted from original by Leyang Feng
# Date Last Modified: June 28, 2016
# Program Purpose: Generates default process emissions for 1B2c_Venting-flaring-oil-gas
#                  using part of EDGAR v4.3.2 data
...
# for non-methane read in the EDGAR v4.3.2 data
#if ( em != 'CH4' )
  EDGAR_raw <- readData( 'EM_INV', domain_extension = "EDGAR/", file_name = paste0( 'EDGAR_v432_', em),
                         extension = ".xlsx", sheet_selection = 1, skip = 7 )
...
# extend edgar to flaring years using edgar 2012 data
