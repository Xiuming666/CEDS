# ------------------------------------------------------------------------------
# Program Name: C1.2.add_NC_emissions_EDGAR_v432.R
...
# Universal header file - provides logging, file support, etc.
    ...
    script_name <- "C1.2.add_NC_emissions_EDGAR_v432.R"
...
EDGAR432_end_year = EDGAR_end_year
...
edgar_year <- colnames( edgar )[ c( grep( '19', colnames( edgar ) ), grep( '20', colnames( edgar ) ) ) ]
...
colnames( edgar ) <- c( 'iso', 'sector', 'fuel','units', edgar_Xyear )

# get rid of 2008 and 2009. Strange Values - years look fine
edgar <- edgar[,c('iso','sector','fuel','units', paste0( 'X',EDGAR_start_year:EDGAR432_end_year ) ) ]
