...
# provide logging, file support, and system functions - and start the script log.
    ...
    log_msg <- "Secondary reformatting of DICE Africa emissions" # First message to be printed to the log
    script_name <- "E.Africa_emissions.R"
...
# 1. Define parameters for inventory-specific script
    inventory_data_file <- paste0('DICE_', em)
...
# Order By ISO2 & sector
    ...
    inv_data_sheet_clean <- inv_data_sheet_clean[ order( inv_data_sheet_clean$Country, inv_data_sheet_clean$Fuel, inv_data_sheet_clean$Sector ), ]
...
# Mapping DICE countries to CEDS iso codes
    ...
    names( inv_data_sheet_clean ) [ 1 ] <- "iso"
