# ------------------------------------------------------------------------------
# Program Name: G2.6.chunk_subVOC_emissions_liquid_gas.R
# Authors: Erin McDuffie, adapted from Leyang Feng, Caleb Braun
# Date Last Updated: Mar 24, 2020
# Program Purpose: Generate multi-year emissions chunks for subVOC emissions for liquid fuel and natural gas anthro emissions.
...
log_msg <- "Generates chunk NetCDF files for subVOC emissions for liquid fuel and natural gas emissions"
source( paste0( PARAM_DIR, "header.R" ) )
initialize( "G2.2.chunk_subVOC_emissions_liquid_gas.R", log_msg, headers )
...
chunk_emissions( singleVarChunking_subVOCemissions_liquid_gas, VOC_em, VOC_names = VOC_names )
