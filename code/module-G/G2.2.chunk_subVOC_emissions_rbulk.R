# ------------------------------------------------------------------------------
# Program Name: G2.2.chunk_subVOC_emissions_rbulk.R
# Authors: Erin McDuffie, adapted from Leyang Feng, Caleb Braun
# Date Last Updated: July 4, 2019
# Program Purpose: Generate multi-year emissions chunks for subVOC emissions for remaining bulk anthro emissions.
...
log_msg <- "Generates chunk NetCDF files for subVOC emissions for remaining bulk emissions"
source( paste0( PARAM_DIR, "header.R" ) )
initialize( "G2.2.chunk_subVOC_emissions_rbulk.R", log_msg, headers )
...
chunk_emissions( singleVarChunking_subVOCemissions_rbulk, VOC_em, VOC_names = VOC_names )
