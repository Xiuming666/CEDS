#------------------------------------------------------------------------------
# Program Name: F1.1.CAN_scaling_2017Update.R
...
#                  aggregate CAN trends inventory data. This data only extends back to 1990,
...
# provide logging, file support, and system functions - and start the script log.
    ...
    log_msg <- "Canada inventory scaling (2017 data)" # First message to be printed to the log
    script_name <- paste0( em, "-F1.1.CAN_scaling_2017Update.R" )
