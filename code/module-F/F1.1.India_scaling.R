...
# India from latest emissions working copy by using India data.
# Input Files: emissions_scaling_functions.R, F.[em]_scaled_EF.csv,
#              F.[em]_scaled_emissions.csv, India_scaling_mapping.xlsx,
...
# provide logging, file support, and system functions - and start the script log.
    ...
    log_msg <- "India inventory scaling" # First message to be printed to the log
    script_name <- paste0( em, "-F1.1.India_scaling.R" )
...
# Aggregate inventory data to scaling sectors/fuels
    inv_data <- F.invAggregate( std_form_inv, region, mapping_method )
