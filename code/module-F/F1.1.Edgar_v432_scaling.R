#------------------------------------------------------------------------------
# Program Name: F1.1.Edgar_v432_scaling.R
# Authors' Names: Erin McDuffie, adpated from original by Tyler Pitkanen, Jon Seibert, Rachel Hoesly
...
#              F.[em]_scaled_emissions.csv, EDGAR_v432_[em].xlsx
# Output Files: F.[em]_total_scaled_EF.csv, F.[em]_total_scaled_emissions.csv,
#               E.[em]_EDGAR_v432_inventory.csv
# Notes:
# TODO:
# ------------------------------------------------------------------------------
...
# provide logging, file support, and system functions - and start the script log.
    ...
    script_name <- paste0( em, "-F1.1.Edgar_v432_scaling.R" )
