...
# provide logging, file support, and system functions - and start the script log.
    ...
    log_msg <- "Africa inventory scaling" # First message to be printed to the log
    script_name <- paste0( em, "-F1.1.Africa_scaling.R" )
...
#   the inventory (as a vector of iso codes)
    ...
    sector_fuel_mapping <- 'Africa_scaling_mapping'
    mapping_method <- 'both'
    inv_name <- 'DICE' #for naming diagnostic files
    region <- c( 'ago','bdi','ben','bfa','bwa','caf','civ','cmr','cog','com',
