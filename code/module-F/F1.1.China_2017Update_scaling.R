#------------------------------------------------------------------------------
# Program Name: F1.1.China_2017Update_scaling.R
...
#              F.[em]_scaled_emissions.csv, MEIC_2017Update_scaling_mapping.xlsx,
#              E.[em]_CHN_2_inventory.csv
...
# provide logging, file support, and system functions - and start the script log.
    ...
    script_name <- paste0( em, "-F1.1.China_2017Update_scaling.R" )
